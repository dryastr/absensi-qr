...
$routes->group('admin', function (RouteCollection $routes) {
   ...
   // Import ZIP
   $routes->get('siswa/import-zip', 'Admin\DataSiswa::importZip');
   $routes->post('siswa/import-zip', 'Admin\DataSiswa::processImportZip');
   ...
   #Menonaktifkan fitur ini karena belum ada model untuk data guru
...
// Custom Routes for API WhatsAPP
$routes->post('admin/absen/masuk', 'Admin\AbsenController::absenMasuk');
$routes->post('admin/absen/pulang', 'Admin\AbsenController::absenPulang');
