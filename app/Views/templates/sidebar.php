...
?>
<div class="sidebar" data-color="<?= $sidebarColor; ?>" data-background-color="black" data-image="<?= base_url('assets/img/sidebar/sidebar1.jpeg'); ?>">
   <!--
   ...
   <div class="logo">
      <a class="simple-text logo-normal">
         <b>Operator<br>SMAN 1 Jakenan</b>
      </a>
   </div>
