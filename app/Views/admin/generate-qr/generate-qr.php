                  ...
                  <div class="card-body">
                    ...
                    <div class="row px-2">
                      <div class="col-12 col-xl-6 px-1">
                        <button onclick="generateAllQrSiswa()" class="btn btn-success p-2 px-md-4 w-100">
                    ...
                    <form action="<?= base_url('admin/qr/siswa/download'); ?>" method="get">
                      ...
                      <div class="row px-2">
                        <div class="col-12 col-xl-6 px-1">
                          <button type="button" onclick="generateQrSiswaByKelas()" class="btn btn-success p-2 px-md-4 w-100">
                            <div class="d-flex align-items-center justify-content-center" style="gap: 12px;">
                              <div>
                                <i class="material-icons" style="font-size: 24px;">qr_code</i>
                              </div>
                              <div>
                                <div class="text-start">
                                  <h5 class="d-inline font-weight-bold">Generate per kelas</h5>
                                </div>
                        ...
                        <div class="col-12 col-xl-6 px-1">
                          <button type="submit" class="btn btn-primary p-2 px-md-4 w-100">
                            <div class="d-flex align-items-center justify-content-center" style="gap: 12px;">
                              ...
                              <div>
                                <div class="text-start">
                                  <h5 class="d-inline font-weight-bold">Download Per Kelas</h5>
                                </div>
                              </div>
                            </div>
                          </button>
