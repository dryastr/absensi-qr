...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-purple mb-48" style="background-color : #9c36b3 !important;">
                        <h4 class="card-title"><b><?= lang('Auth.register') ?></b></h4>
                    ...
                    <div class="card-body mx-5 my-3">
                        ...
                        <form action="<?= url_to('register') ?>" method="post">
                            ...
                            <button type="submit" class="btn btn-block" style="background-color : #9c36b3;"><?= lang('Auth.register') ?></button>
                        </form>
                    </div>
                </div>
            </div>
