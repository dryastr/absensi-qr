            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card card-stats">
                    <div class="card-header card-header-icon">
                        <div class="card-icon" style="background-color : #9024a3;">
                            <a href="<?= base_url('admin/petugas'); ?>" class="text-white" style="padding-left : 10px">
                                <i class="material-icons" style="margin-right : -10px">laptop mac</i>
                            </a>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-chart">
                    ...
                    <div class="card-footer">
                        <div class="stats">
                            <i class="material-icons text-primary">checklist</i> <a class="text-primary" href="<?= base_url('admin/absen-siswa'); ?>">Tingkat Kehadiran Siswa</a>
                        </div>
                    </div>
                </div>
            </div>
