            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="row">
                                        <div class="col-md-4 col-lg-5">
                                            <h4 class="card-title"><b>Upload Data Siswa</b></h4>
                    ...
                    <div class="col-12 col-xl-4">
                        <div class="card">
                            <div class="card-header card-header-tabs card-header-primary">
                                <h4 class="card-title"><b>Dokumen Bantuan</b></h4>
                                <p class="card-category">Dokumen bantuan untuk input data siswa</p>
                            </div>
                            <div class="card-body">
                                <form action="<?= base_url('admin/siswa/downloadCSVFilePost'); ?>" method="post">
                                    <?= csrf_field(); ?>
                                    <button type="button" class="btn btn-success btn-block" data-toggle="modal" data-target="#modalKelas">List Kelas Berdasarkan Id</button>
